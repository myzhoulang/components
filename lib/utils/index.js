...
var noop = function noop() {}; // 默认获取 oss 配置方法
...
var getExtraData = /*#__PURE__*/ (function () {
  var _ref = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee(file, oss) {
      var ext;
...
var uploadValid = function uploadValid(file, config) {
  var _conf$exts;
...
var getFilePath = function getFilePath(files) {
  ...
  if (Object.prototype.toString.call(files) === '[object Object]') {
    return (0, _objectSpread2.default)(
      (0, _objectSpread2.default)({}, files),
      {},
      {
